...
playing = True
d6_1 = random.randint(1, 6)  # Die one
d6_2 = random.randint(1, 6)  # Die two
roll = (d6_1 + d6_2)  # The added dice number
bet = (int(1))  # The amount of money you have bet
...
while money > 0 and playing:
    ...
    roll  # This just adds the dice rolls each turn
    print()
